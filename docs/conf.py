...
# -*- coding: utf-8 -*-
"""
options documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'options'))
...
project = u'options'
_full_version = options.__version__
author = options.__author__
copyright = options.__copyright__
...
latex_documents = [
    (master_doc, 'options.tex', u'options Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'options', 'options Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'options', 'options Documentation',
     author, 'options', options.__descr__,
     'Miscellaneous'),
]
